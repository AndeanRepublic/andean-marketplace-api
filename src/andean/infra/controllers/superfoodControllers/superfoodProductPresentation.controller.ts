...
import { SuperfoodProductPresentationResponse } from '../../../app/models/superfoods/SuperfoodProductPresentationResponse';
...
import { UpdateSuperfoodProductPresentationUseCase } from '../../../app/use_cases/superfoods/productPresentation/UpdateSuperfoodProductPresentationUseCase';
...
export class SuperfoodProductPresentationController {
	constructor(
		...
		private readonly updateSuperfoodProductPresentationUseCase: UpdateSuperfoodProductPresentationUseCase,
	) {}
	...
	@ApiOperation({
		...
		description: 'Actualiza una presentación de producto por su ID',
	})
	@ApiParam({
		name: 'id',
		description: 'ID de la presentación',
	...
	async updateProductPresentation(
		@Param('id') id: string,
		@Body() dto: CreateSuperfoodProductPresentationDto,
	): Promise<SuperfoodProductPresentationResponse> {
		return await this.updateSuperfoodProductPresentationUseCase.handle(id, dto);
	}
