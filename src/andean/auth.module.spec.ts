...
/**
 * Unit test for the EmailRepository factory defined inline in AuthModule.
 *
...
describe('AuthModule — EmailRepository factory', () => {
	...
	it('throws when EMAIL_PROVIDER has an invalid value', () => {
		...
		expect(() =>
			...
			"Invalid EMAIL_PROVIDER: 'sendgrid'. Valid values: 'resend' | 'ses'",
		);
	});
});
