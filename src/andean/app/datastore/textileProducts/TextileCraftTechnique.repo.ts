...
export abstract class TextileCraftTechniqueRepository {
  ...
  abstract getTextileCraftTechniqueById(id: string): Promise<TextileCraftTechnique | null>;
  abstract saveTextileCraftTechnique(technique: TextileCraftTechnique): Promise<TextileCraftTechnique>;
