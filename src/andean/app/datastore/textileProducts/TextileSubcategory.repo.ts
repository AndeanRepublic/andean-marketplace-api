...
export abstract class TextileSubcategoryRepository {
  ...
  abstract getTextileSubcategoryById(id: string): Promise<TextileSubcategory | null>;
  abstract saveTextileSubcategory(subcategory: TextileSubcategory): Promise<TextileSubcategory>;
