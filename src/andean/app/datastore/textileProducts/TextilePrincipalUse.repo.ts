...
export abstract class TextilePrincipalUseRepository {
  ...
  abstract getTextilePrincipalUseById(id: string): Promise<TextilePrincipalUse | null>;
  abstract saveTextilePrincipalUse(principalUse: TextilePrincipalUse): Promise<TextilePrincipalUse>;
