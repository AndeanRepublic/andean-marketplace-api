...
export class CreateCustomerUseCase {
	...
	async handle(userDto: CreateCustomerDto): Promise<CustomerProfile> {
		...
		// Create account (id will be generated by MongoDB)
		...
		// Use Account._id as userId in CustomerProfile (foreign key)
		const customerToSave = CustomerProfileMapper.fromCreateDto(
			savedAccount.id,
			userDto,
		);
